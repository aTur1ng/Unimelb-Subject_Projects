...
public class ServiceProvider
{
	...
	{
//		return new ResourceServiceDummy();
	...
	public static SocketHandlerService getSocketHandlerService(Socket socket, ServerListService serverService,
			ResourceService resourceService, ServerAddress myServer, boolean secure)
	{
		// return new SocketHandlerServiceImpl(socket, serverService,
		// resourceService);
		return new SocketHandlerServiceDummy(socket, serverService, resourceService, myServer, secure);
	}
