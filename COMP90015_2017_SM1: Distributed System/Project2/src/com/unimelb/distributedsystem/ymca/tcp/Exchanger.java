...
public class Exchanger extends Thread
{
	...
	public Exchanger(ServerOptions options, ServerListService service, boolean secure)
	{
	...
	public void run()
	{
		...
		while (!Hook.isTerminate())
		{
			...
			sendServerListToRandomServer(secure);
		}
		LoggerUtil.println("Terminating Exchanger." + Hook.isTerminate());
	}

	private void sendServerListToRandomServer(boolean secure)
	{
